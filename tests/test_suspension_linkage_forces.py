...
class SuspensionForceTests(unittest.TestCase):
    ...
    def test_standalone_viewer_embeds_geometry_and_results(self):
        ...
        self.assertIn('id="rockerGeometryVisual"', html)
        self.assertIn("function renderMethodGeometry()", html)
        self.assertIn("default 3D orientation in an orthographic projection", html)
        self.assertIn('id="methodsAssembly"', html)
        self.assertIn('id="methodsLoadCase"', html)
